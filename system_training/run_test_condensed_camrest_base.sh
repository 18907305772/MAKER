...
python test.py \
    ...
    --test_model_path others/result/camrest/RRG_v3_micro_cdnet/new_joint_gt-retrieval_seed-111_gtml-200_rtml-128_rkml-200_asml-64_gdml-100_rdml-128_kdml-100_dus-100_topd-6_gdre-24000-avg_wo_context-kl-1.0_dlx_dk_gtdb/checkpoint/generator_best_dev \
