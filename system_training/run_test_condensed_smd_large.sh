...
python test.py \
    ...
    --test_model_path others/result/smd/RRG_v3_micro_qtod/new_joint_t5-large_seed-111_gtml-200_rtml-128_rkml-200_asml-128_gdml-200_rdml-128_kdml-200_dus-100_topd-8_dk_es-48000_gtdb/checkpoint/generator_best_dev \
