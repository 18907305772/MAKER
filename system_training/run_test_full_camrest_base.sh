...
python test.py \
    ...
    --test_model_path others/result/camrest/RRG_v3_micro_cdnet/new_joint_seed-111_gtml-200_rtml-128_rkml-200_asml-64_gdml-100_rdml-128_kdml-100_dus-100_topd-7_tha-0.1_rk-0-avg-tm-0-bce-1.0-cr_gdre-30000-avg_wo_context-kl-1.0_dlx_dk-mk_es-48000/checkpoint/generator_best_dev \
    --use_ranker True \
